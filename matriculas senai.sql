...
(SELECT 
	...
	LINHAACAO.DESCRICAO 		AS MAT_TIPOAMBIENTE,
	CASE 
...
WHERE  
	...
	--AND (CONVERT(DATE,SHABILITACAOALUNOCOMPL.DTINICIOSI) != CONVERT(DATE,STURMA.DTINICIAL) OR PPESSOA.DTNASCIMENTO IS NULL OR PPESSOA.SEXO IS NULL OR PPESSOA.GRAUINSTRUCAO IS NULL OR PPESSOA.CORRACA IS NULL)
) TAB 
