...
(SELECT 
	...
	END AS MAT_DATAPREVTERMI,
		CASE WHEN SMODALIDADECURSO.CODMODALIDADECURSO IN(15,31) THEN @DATAATE
				ELSE 
					CASE
						...
						WHEN (CONVERT(DATE,SLOGPLETIVO.DTALTERACAO) <= CONVERT(DATE,SHABILITACAOALUNOCOMPL.DATAINICIAL) AND CONVERT(DATE,STURMA.DTFINAL) <= @DATAATE) THEN CONVERT(DATE,SHABILITACAOALUNOCOMPL.DATAINICIAL)
					ELSE
						CONVERT(DATE,SLOGPLETIVO.DTALTERACAO)
					END
	...
	/*TRECHO PARA CAPTURAR O STATUS*/
		...
		ELSE 
			CASE WHEN SMODALIDADECURSO.CODMODALIDADECURSO NOT IN (15,31) THEN SMATRICPL.CODSTATUS
	...
	'' AS MAT_PESSOAFISOUJUR,
	'' AS RESPF_CNPJ,
	'' AS RESPF_CPF,
	'' AS RESPF_NOME,
	'' AS RESPF_RUA,
	'' AS RESPF_NUMERO,
	'' AS RESPF_COMPLEMENTO,
	'' AS RESPF_BAIRRO,
	'' AS RESPF_MUNICIPIO,
	'' AS RESPF_ESTADO,
	'' AS RESPF_CEP,
