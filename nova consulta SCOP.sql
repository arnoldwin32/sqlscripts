...
(SELECT 
	...
	CASE
		...
		CASE
			WHEN
				SMATRICPL.CODSTATUS = 1
			THEN
				0
			WHEN
				SMATRICPL.CODSTATUS IN ('2','9','11','12','18')
			THEN
				1
			WHEN
				SMATRICPL.CODSTATUS IN ('10','16')
			THEN
				2
			WHEN
				SMATRICPL.CODSTATUS = 5
			THEN
				4
			WHEN
				SMATRICPL.CODSTATUS IN (4,8,17)
			THEN
				5
			WHEN 
				SMATRICPL.CODSTATUS = 7
			THEN
				6
			WHEN
			...
			THEN
				7
			WHEN
				SMATRICPL.CODSTATUS IN (3,6,47)
			THEN
				8
			WHEN
				SMATRICPL.CODSTATUS = 46
			THEN
				9
			WHEN
				SMATRICPL.CODSTATUS IN (13,20)
			THEN
				10
			WHEN
				SMATRICPL.CODSTATUS = 48
			THEN
				11
			END
	END	AS MAT_SITUACAO,
...
WHERE  
    ...
    AND STURMA.CODTURMA = 'COM-PIND-15'
