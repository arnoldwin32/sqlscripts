...
JOIN STURMA (NOLOCK) ON 
	 ...
	 SMATRICPL.CODTURMA = ( SELECT MAX(CODTURMA) FROM SMATRICPL SMP
	 						WHERE SMATRICPL.CODCOLIGADA = SMP.CODCOLIGADA
	 						AND   SMATRICPL.CODFILIAL = SMP.CODFILIAL
	 						AND	  SMATRICPL.IDHABILITACAOFILIAL = SMP.IDHABILITACAOFILIAL
	 						AND   SMATRICPL.CODTURMA = SMP.CODTURMA
	 	)
